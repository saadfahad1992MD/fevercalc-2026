...
import { medicationsEgypt, suppositoriesEgypt } from '@/data/countries/medicationsEgypt.js'
import '@/App.css'
...
function App({ onChangeLanguage, country = 'DEFAULT' }) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100" dir="rtl">
      <LanguageToggle currentLanguage="ar" targetLanguage="en" countryCode="eg" onToggle={onChangeLanguage} />
      {/* Top Brand Header */}
