...
import { medicationsEgyptEnglish, suppositoriesEgyptEnglish } from '@/data/countries/medicationsEgyptEnglish.js'
import '@/App.css'
...
function AppEnglish({ onChangeLanguage, country = 'DEFAULT' }) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      <LanguageToggle currentLanguage="en" targetLanguage="ar" countryCode="eg" onToggle={onChangeLanguage} />
      {/* Top Brand Header */}
