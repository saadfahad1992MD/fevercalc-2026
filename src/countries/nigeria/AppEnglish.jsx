...
const medications = { paracetamol: medicationsNigeria.paracetamol, ibuprofen: medicationsNigeria.ibuprofen };
const suppositories = medicationsNigeria.suppositories;
...
function AppEnglish({ onChangeLanguage }) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      {/* Nigeria is English-only, no language toggle needed */}
      {/* Top Brand Header */}
