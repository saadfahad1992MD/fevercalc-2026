...
import { medicationsIndiaEnglish } from '@/data/countries/medicationsIndiaEnglish.js'
import '@/App.css'
...
function AppEnglish({ onChangeLanguage }) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      <LanguageToggle currentLanguage="en" targetLanguage="hi" countryCode="in" onToggle={onChangeLanguage} />
      {/* Top Brand Header */}
