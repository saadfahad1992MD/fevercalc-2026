...
function App({ onChangeLanguage }) {
  ...
  const MedicationCard = ({ medication, category }) => {
    ...
    const isIbuprofen = medication.ingredient === 'إيبوبروفين'
    ...
    const handleClick = () => {
      ...
      if (isSuppositoryUnsuitable) {
        alert(`⚠️ تنبيه: هذه التحميلة غير مناسبة لطفلك\n${unsuitabilityReason}`)
        return
      }
              ...
              onClick={(e) => {
                ...
                setTimeout(() => {
                  ...
                  if (resultsSection) {
                    ...
                    // Account for sticky header height (approximately 88px)
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      >
                        <div className="text-center">
                          ...
                          <div>أقل من سنة</div>
                          <div className="text-xs opacity-70">(1-12 شهر)</div>
                        </div>
                      </Button>
                      <Button
                        type="button"
                      ...
                      >
                        <div className="text-center">
                          <div className="text-2xl mb-1">🧒</div>
                          <div>أكثر من سنة</div>
                          <div className="text-xs opacity-70">(1-14 سنة)</div>
                        </div>
                      </Button>
                    </div>
                  </div>
                        ...
                        <SelectContent>
                          {ageCategory === 'infant' ? (
                            ...
                            <>
                              ...
                              {/* 32-60 kg: Every 2 kg */}
                              {Array.from({ length: 15 }, (_, i) => 32 + (i * 2)).map(w => (
                                <SelectItem key={w} value={w.toString()}>
                                  {w} كجم
                                </SelectItem>
                              ))}
              ...
              {medicationType === 'suppository' && (
                <>
                  ...
                  <div>
                    <div className="flex items-center gap-2 mb-4">
                      <div className="w-4 h-4 bg-blue-500 rounded-full"></div>
                      <h3 className="text-lg font-semibold text-blue-700">تحاميل الباراسيتامول</h3>
                    </div>
                    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                  ...
                  <div>
                    <div className="flex items-center gap-2 mb-2">
                      <div className="w-4 h-4 bg-green-500 rounded-full"></div>
                      <h3 className="text-lg font-semibold text-green-700">تحاميل الديكلوفيناك</h3>
                      <Badge variant="outline" className="text-green-600">
                        العمر أكبر من سنة
                      </Badge>
                    </div>
